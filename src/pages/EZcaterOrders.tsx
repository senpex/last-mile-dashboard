...
const EZcaterOrders = () => {
  ...
  // Search controls
  const searchControls = <Input placeholder="Search orders by ID, customer, or location..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full md:w-80" />;
  return <Layout>
