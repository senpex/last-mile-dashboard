...
const Index = () => {
  ...
  // Column definitions - added default property to each column option
  const columnOptions: ColumnOption[] = [
    ...
    { id: "pickupLocation", label: "Pickup Location", default: false },
    { id: "dropoffLocation", label: "Dropoff Location", default: false },
