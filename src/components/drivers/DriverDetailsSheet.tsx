                                  ...
                                  <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">{document.type} • {document.uploadDate}</p>
                                      </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Button variant="ghost" size="sm" onClick={() => window.open(`/documents/${document.id}`, '_blank')}>
                                        View
                                      </Button>
                                    </div>
                                  </div>
