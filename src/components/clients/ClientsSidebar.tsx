...
export function ClientsSidebar({
  ...
  return (
    <div className={`fixed left-[240px] top-0 h-full transition-all duration-300 z-20 ${open ? "translate-x-0" : "-translate-x-full"}`}>
      <div className="w-[280px] h-full bg-background border-r shadow-md flex flex-col">
