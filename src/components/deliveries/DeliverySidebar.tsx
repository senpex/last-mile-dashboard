...
export function DeliverySidebar({
  ...
  return (
    <div className={`h-full bg-background transition-all duration-300 overflow-hidden ${open ? 'w-[275px] max-w-[80vw] border-r' : 'w-0'}`}>
      <div className="w-[275px] h-full flex flex-col">
