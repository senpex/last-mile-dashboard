...
export const ImagesSection = ({}: ImagesSectionProps) => {
  ...
  // Sample image data for each category - ensure they're never null
        ...
        <div className="flex items-center justify-between">
          ...
          {isEditing && (
            <Button
              ...
              onClick={() => handleAddImage(safeImages, setImages)}
            >
              ...
              <div className="flex items-center gap-1">
                ...
                {isEditing && (
                  <Button
                    ...
                    onClick={() => handleDeleteImage(image.id, safeImages, setImages)}
                  >
