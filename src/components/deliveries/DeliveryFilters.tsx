          ...
          <div className="flex items-center gap-4">
            ...
            >
              <ToggleGroupItem 
                ...
                className="px-3 text-xs rounded-md h-9 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground"
              >
                Me
              </ToggleGroupItem>
              <ToggleGroupItem 
            ...
            <div className="flex items-center">
              ...
              <Tabs 
                ...
                className="w-auto"
              >
                <TabsList className="inline-flex h-9 bg-muted space-x-1 items-center justify-center">
                  <TabsTrigger 
                    value="main" 
                    className="px-3 text-xs rounded-md h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground relative"
                  >
                    Main view
                  </TabsTrigger>
                  <TabsTrigger 
                    value="attention" 
                    className="px-3 text-xs rounded-md h-9 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground relative flex items-center"
                  >
                    Attention Required
