  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-4">
          ...
          <div className="space-y-2">
            {filteredRecipients.map(recipient => (
              <div 
                key={recipient.id}
                className={cn(
                  "flex items-center p-2 rounded-md cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800",
      ...
      <div className="mb-5">
        ...
        >
          <ToggleGroupItem 
            ...
            className={`${channels.includes('sms') ? 'bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700' : 'bg-gray-100 text-foreground dark:bg-gray-800 dark:text-gray-300 hover:bg-red-100 hover:text-red-700 dark:hover:bg-red-900/30 dark:hover:text-red-200'} transition-colors`}
          >
          ...
          <ToggleGroupItem 
            ...
            className={`${channels.includes('email') ? 'bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700' : 'bg-gray-100 text-foreground dark:bg-gray-800 dark:text-gray-300 hover:bg-red-100 hover:text-red-700 dark:hover:bg-red-900/30 dark:hover:text-red-200'} transition-colors`}
          >
          ...
          <ToggleGroupItem 
            ...
            className={`${channels.includes('inapp') ? 'bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700' : 'bg-gray-100 text-foreground dark:bg-gray-800 dark:text-gray-300 hover:bg-red-100 hover:text-red-700 dark:hover:bg-red-900/30 dark:hover:text-red-200'} transition-colors`}
          >
      ...
      <div className="flex justify-end space-x-4">
        <Button 
          variant="outline" 
          className="flex items-center gap-1 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
        >
