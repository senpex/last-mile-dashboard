        ...
        <ToggleGroupItem 
          ...
          className={`
            ${channels.includes('sms') 
              ? 'bg-green-600 text-white hover:bg-green-700 light:bg-green-600 light:text-white light:hover:bg-green-700 dark:bg-green-600 dark:text-white dark:hover:bg-green-700' 
